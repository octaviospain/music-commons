...
public class JAudioTaggerMetadataParser implements AudioItemMetadataParser {
    ...
    public AudioItem parseAudioItem(Path audioItemPath) throws AudioItemManipulationException {
        ...
        ImmutableAudioItem.ImmutableAudioItemBuilder audioItemBuilder;
        ...
        try {
            ...
            audioItemBuilder = ImmutableAudioItem.builder(audioItemPath, name, duration, bitRate);
    ...
    private void parseMetadata(ImmutableAudioItem.ImmutableAudioItemBuilder builder, Tag tag) {
    ...
    private void parseAlbum(ImmutableAudioItem.ImmutableAudioItemBuilder builder, String extension, Tag tag) {
        final Album album;
