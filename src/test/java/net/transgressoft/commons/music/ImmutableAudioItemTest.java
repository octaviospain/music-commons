...
class ImmutableAudioItemTest {
    ...
    void propertiesTest() {
        audioItem =
                ImmutableAudioItem.builder(path, name, duration, bitRate)
                        .album(album)
                        .artist(artist)
                        .bpm(bpm)
        ...
        AudioItem modifiedAlbum = audioItem
                .name("Other title").album(new ImmutableAlbum("Other album", new ImmutableArtist("Other artist"), true, (short) 1999, ImmutableLabel.UNKNOWN))
    ...
    class namesInArtistField {
        ...
        private void initTrackWithArtistAndResult(String artistString, String... expectedArtist) {
            audioItem = ImmutableAudioItem.builder(path, name, duration, bitRate)
    ...
    class namesInsideAlbumArtistField {
        ...
        private void initializeWithNameAndResult(String albumArtistString, String... expectedArtist) {
            audioItem = ImmutableAudioItem.builder(path, "", duration, bitRate)
