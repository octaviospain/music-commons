...
class JAudioTaggerMetadataWriterTest {
    ...
    static Artist artist = new SimpleArtist("Artist", CountryCode.UK);
    ...
    public static void beforeAllTests() throws Exception {
        ...
        album = new SimpleAlbum("Album", artist, false, (short) 1992, new SimpleLabel("EMI", CountryCode.US), coverBytes);
