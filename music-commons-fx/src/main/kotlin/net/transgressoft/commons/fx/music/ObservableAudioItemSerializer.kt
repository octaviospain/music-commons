...
internal object ObservableAudioItemSerializer : KSerializer<ObservableAudioItem> {
    override val descriptor: SerialDescriptor = buildClassSerialDescriptor("AudioItem") {
        element<String>("id")
        element<String>("path")
    }

    override fun deserialize(decoder: Decoder): ObservableAudioItem {
        ...
        return ObservableAudioItem(
            ...
            ImmutableAlbum(
                albumName,
                ImmutableArtist.of(albumArtistName),
                isCompilation,
                year.toShort(),
    ...
    override fun serialize(encoder: Encoder, value: ObservableAudioItem) {
