...
/**
 * Co-located population SPI for [FXAudioItem].
 *
 ...
 * [FXAudioItem_LirpRawConstructor]. JSON deserialization restores values through the reflective
 * serializer instead and does not consult this initializer.
 */
@Suppress("UNCHECKED_CAST", "ClassName")
internal class FXAudioItem_LirpRawInitializer : LirpRawInitializer<FXAudioItem> {
    override val entries: List<RawInitEntry<FXAudioItem>> =
        listOf(
            RawInitEntry(
                name = "metadata",
