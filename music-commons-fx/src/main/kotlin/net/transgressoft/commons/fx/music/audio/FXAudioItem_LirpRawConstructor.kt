...
/**
 * Co-located construction SPI for [FXAudioItem].
 *
 ...
 * by [FXAudioItem_LirpRawInitializer].
 *
 ...
 */
@Suppress("ClassName")
internal class FXAudioItem_LirpRawConstructor : LirpRawConstructor<FXAudioItem> {
    override fun construct(params: Map<String, Any?>): FXAudioItem =
        FXAudioItem(
            params["path"] as Path,
            params["id"] as Int,
