...
/**
 * Co-located population SPI for [FXPlaylist].
 *
 ...
 * during SQL bulk-load. The `id` identity field is supplied by [FXPlaylist_LirpRawConstructor];
 * the aggregate collections are wired separately by [FXPlaylist_LirpRefAccessor].
 */
@Suppress("UNCHECKED_CAST", "ClassName")
internal class FXPlaylist_LirpRawInitializer : LirpRawInitializer<FXPlaylist> {
    override val entries: List<RawInitEntry<FXPlaylist>> =
        listOf(
            RawInitEntry(
                name = "name",
