 ...
 */
class JAudioTaggerMetadataParser implements AudioItemMetadataParser {
    ...
    public AudioItem parseAudioItem(Path audioItemPath) throws AudioItemManipulationException {
        ...
        try {
            ...
            audioItemBuilder = new ImmutableAudioItemBuilder(audioItemPath, name, duration, bitRate, LocalDateTime.now());
    ...
    private void parseMetadata(AudioItemBuilder<AudioItem> builder, Tag tag) {
    ...
    private void parseAlbum(AudioItemBuilder<AudioItem> builder, String extension, Tag tag) {
        final Album album;
