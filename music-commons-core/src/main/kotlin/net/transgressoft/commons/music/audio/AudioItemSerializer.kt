...
internal object AudioItemSerializer : AudioItemSerializerBase<AudioItem>() {
    ...
    override fun createInstance(propertiesList: List<Any?>): AudioItem {
        return MutableAudioItem(propertiesList[0] as Path,
            ...
            ImmutableAlbum(propertiesList[7] as String, ImmutableArtist(propertiesList[8] as String), propertiesList[9] as Boolean,
