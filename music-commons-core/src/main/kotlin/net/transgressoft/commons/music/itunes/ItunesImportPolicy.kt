 ...
 *
 * The policy controls metadata source, play count transfer, tag write-back, and file type filtering.
 * All fields have sensible defaults matching the most common import scenario. Tracks whose files
 * do not exist on disk are always recorded in [ImportResult.unresolved] with reason
 * [UnresolvedReason.FileNotFound] -- consumers handle missing files by inspecting the result.
 *
