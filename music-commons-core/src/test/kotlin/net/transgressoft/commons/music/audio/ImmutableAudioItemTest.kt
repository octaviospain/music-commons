...
internal class ImmutableAudioItemTest {
    ...
    internal inner class ArtistsInvolved {
        ...
        internal inner class InArtistField {
            ...
            fun oneNameWithLeadingSpacesInArtist() {
                initAudioItemAndExpectedArtists(title, "Adam      Beyer", "", "Adam Beyer")
                assertEquals(expectedArtists, audioItem.artistsInvolved)
            }
            ...
            fun oneNameWthLeadingAndTrailingSpacesInArtist() {
                initAudioItemAndExpectedArtists(title, "   Adam Beyer    ", "", "Adam Beyer")
                assertEquals(expectedArtists, audioItem.artistsInvolved)
            }
            ...
            @Test
            @DisplayName("One name with leading and trailing spaces")
            fun oneNameWthLeadingTrailingAndBetweenSpacesInArtist() {
                initAudioItemAndExpectedArtists(title, "   Adam    Beyer    ", "", "Adam Beyer")
                assertEquals(expectedArtists, audioItem.artistsInvolved)
            }
            ...
            internal inner class CommaSeparated {
                @Test
                @DisplayName("Two names")
                fun twoNamesCommaSeparated() {
                ...
                fun twoNamesCommaSeparatedWithTrailingSpaces() {
                    initAudioItemAndExpectedArtists(title, "Adam Beyer  , Ida Engberg   ", "", "Adam Beyer", "Ida Engberg")
                    assertEquals(expectedArtists, audioItem.artistsInvolved)
                }
                ...
                fun twoNamesCommaSeparatedWithLeadingSpaces() {
                    initAudioItemAndExpectedArtists(title, "Adam    Beyer, Ida   Engberg", "", "Adam Beyer", "Ida Engberg")
                    assertEquals(expectedArtists, audioItem.artistsInvolved)
                }
                ...
                fun threeNamesCommaWithLeadingAndTrailingSpacesSeparated() {
                    initAudioItemAndExpectedArtists(
                        title,
                        "Adam    Beyer  ,   Ida  Engberg ,   UMEK ",
                        "",
                        "Adam Beyer",
                        "Ida Engberg",
                        "UMEK"
                ...
                fun twoNamesRepeatedCommaSeparated() {
            ...
            internal inner class AnpersandSeparated {
                @Test
                @DisplayName("Two names")
                fun twoNamesAndpersandSeparated() {
                    initAudioItemAndExpectedArtists(title, "Adam Beyer & Ida Engberg", "", "Adam Beyer", "Ida Engberg")
                    assertEquals(expectedArtists, audioItem.artistsInvolved)
                }
                ...
                fun twoNamesAndpersandWithSpacesSeparated() {
                    initAudioItemAndExpectedArtists(title, "Adam   Beyer  &     Ida Engberg ", "", "Adam Beyer", "Ida Engberg")
                    assertEquals(expectedArtists, audioItem.artistsInvolved)
                }
                ...
                @Test
                @DisplayName("Three names")
                fun threeNamesAndpersandSeparated() {
                    initAudioItemAndExpectedArtists(title, "Adam Beyer & Ida Engberg & UMEK", "", "Adam Beyer", "Ida Engberg", "UMEK")
                    assertEquals(expectedArtists, audioItem.artistsInvolved)
                }
                ...
                @Test
                @DisplayName("Three names with leading and trailing spaces")
                fun threeNamesAndpersandWithSpacesSeparated() {
                    initAudioItemAndExpectedArtists(
                        title, "adam   beyer  & ida  engberg &  uMEK ", "", "Adam Beyer", "Ida Engberg",
                        "UMEK"
                    )
                    assertEquals(expectedArtists, audioItem.artistsInvolved)
                }
                ...
                @Test
                @DisplayName("Two repeated names")
                fun twoNamesRepeatedAnpersandSeparated() {
                    initAudioItemAndExpectedArtists(title, "Adam Beyer & Adam Beyer", "", "Adam Beyer")
                    assertEquals(expectedArtists, audioItem.artistsInvolved)
                }
            }
            ...
            internal inner class VsSeparated {
                @Test
                @DisplayName("Two names")
                fun twoNamesvsSeparated() {
                ...
                @Test
                @DisplayName("Two repeated names")
                fun twoNamesRepeatedVsSeparated() {
            ...
            internal inner class VersusSeparated {
                @Test
                @DisplayName("Two names")
                fun twoNamesVersusSeparated() {
                ...
                @Test
                @DisplayName("Three names")
                fun threeNamesVersusSeparated() {
                    initAudioItemAndExpectedArtists(
                        title, "adam Beyer versus Ida Engberg Versus umek", "", "Adam Beyer",
                        "Ida Engberg", "Umek"
                    )
                    assertEquals(expectedArtists, audioItem.artistsInvolved)
                }
                ...
                @Test
                @DisplayName("Two repeated names")
                fun twoNamesRepeatedVersusSeparated() {
            ...
            @Nested
            @DisplayName("'vs.' separated")
            internal inner class VsDotSeparated {
                @Test
                @DisplayName("Two names")
                fun twoNamesVsDotSeparated() {
                    initAudioItemAndExpectedArtists(title, "Adam Beyer vs. Ida Engberg", "", "Adam Beyer", "Ida Engberg")
                    assertEquals(expectedArtists, audioItem.artistsInvolved)
                }
                ...
                @Test
                @DisplayName("Three names")
                fun threeNamesVsDotSeparated() {
                    initAudioItemAndExpectedArtists(
                        title, "Adam Beyer vs. Ida Engberg Vs. UMEK", "", "Adam Beyer",
                        "Ida Engberg", "UMEK"
                    )
                    assertEquals(expectedArtists, audioItem.artistsInvolved)
                }
                ...
                @Test
                @DisplayName("Two repeated names")
                fun twoNamesRepeatedVsDotSeparated() {
                    initAudioItemAndExpectedArtists(title, "Adam Beyer Vs. Adam Beyer", "", "Adam Beyer")
                    assertEquals(expectedArtists, audioItem.artistsInvolved)
                }
            }
            ...
            internal inner class FeatSeparated {
                @Test
